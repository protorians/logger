...
/**
 * A logging utility class that provides methods for various log levels with customizable options,
 * such as colorized output, timestamp formatting, and prefixing.
 */
export class Logger {
    constructor(
